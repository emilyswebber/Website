...
&nbsp;
  ...
  The Foundation allows me creative freedom to apply my expertise with data to solving a variety of in-house challenges. I create ensemble models that integrate the theoretical framework of Regression, SVM/SMOTe, and Random Forests. These models accurately predicted more than 70 million dollars in revenue in the first year alone. In addition to designing new models and metrics, I also conduct comprehensive analyses on Foundation performance and operations. This work is all done in collaboration with the outstanding professionals in the various departments at the OHSU Foundation. Outside bench-marking agencies have referred to our collective efforts as "cutting-edge" in the field. I hope to continue to push boundaries in my current position, and aim to facilitate the greatness that already exists within this amazing organization.
